...
class Game:
    ...
    def __init__(self):
        ...
        self.mode = 0
        self.shop_slots = [pygame.rect.Rect(1040 + 140 * i, 100, TILESIZE, TILESIZE) for i in range(0, 4)]
        self.reserve_slots = [pygame.rect.Rect(1040 + 140 * i, 385, TILESIZE, TILESIZE) for i in range(0, 4)]
